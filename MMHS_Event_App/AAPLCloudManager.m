...
- (void)createReferenceItemSchemaWithCompletionHandler:(void (^)(NSArray *records))completionHandler {
    ...
    firstSubitem[NameField] = @"buy milk";
    firstSubitem[ParentField] = [[CKReference alloc] initWithRecordID:firstParentRecordID action:CKReferenceActionDeleteSelf];
    ...
    secondSubitem[NameField] = @"fix bugs";
    secondSubitem[ParentField] = [[CKReference alloc] initWithRecordID:secondParentRecordID action:CKReferenceActionDeleteSelf];
